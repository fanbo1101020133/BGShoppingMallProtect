...
class ShoppingCarTableViewController: UITableViewController {

    override func viewDidLoad() {
        super.viewDidLoad()

        tableView.register(UINib(nibName:"ShoppingCarFirstCellView", bundle: nil), forCellReuseIdentifier: "ShoppingCarFirstCell")
